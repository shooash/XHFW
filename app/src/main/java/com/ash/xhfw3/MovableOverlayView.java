...
public class MovableOverlayView extends RelativeLayout {
	...
	public MovableOverlayView(Activity activity, Resources resources,
		...
		/*mTitleBarIconType = mPref.getInt(Common.KEY_WINDOW_TITLEBAR_*ICON_TYPE,
		...
		popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
			...
			public boolean onMenuItemClick(MenuItem item) {
				if (item.getTitle().equals(item1)) {
					...
					mAeroSnap.forceSnapGravity(Gravity.TOP);
				} else if (item.getTitle().equals(menu_item4_sub2)) {
					mAeroSnap.forceSnapGravity(Gravity.BOTTOM);
				} else if (item.getTitle().equals(menu_item4_sub3)) {
					mAeroSnap.forceSnapGravity(Gravity.LEFT);
				} else if (item.getTitle().equals(menu_item4_sub4)) {
					mAeroSnap.forceSnapGravity(Gravity.RIGHT);
				}
				//4WAYMOD
				else if (item.getTitle().equals(menu_item4_sub5)) {
					mAeroSnap.forceSnapGravity(Gravity.TOP | Gravity.LEFT);
				} else if (item.getTitle().equals(menu_item4_sub6)) {
					mAeroSnap.forceSnapGravity(Gravity.TOP | Gravity.RIGHT);
				}else if (item.getTitle().equals(menu_item4_sub7)) {
					mAeroSnap.forceSnapGravity(Gravity.BOTTOM | Gravity.LEFT);
				} else if (item.getTitle().equals(menu_item4_sub8)) {
					mAeroSnap.forceSnapGravity(Gravity.BOTTOM | Gravity.RIGHT);
				}*/
				return false;
			}
		});
